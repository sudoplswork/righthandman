...
schema_write_file = types.FunctionDeclaration(
    name="write_file",
    description="Writes content provided to the name listed in file path. Execution is constrained to the working directory.",
    parameters=types.Schema(
        ...
        properties={
            ...
            "content": types.Schema(
                type=types.Type.STRING,
                description="The content that will be written to the file. Execution is constrained to the working directory.",
            ),
        },
    ),
)
